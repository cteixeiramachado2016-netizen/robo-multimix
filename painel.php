...
// 3. Consulta a tabela historico_precos - RECONSTRUÍDO DO ZERO
...
// IMPORTANTE: Reseta completamente qualquer herança de POST que o PHP tente injetar
curl_setopt($ch, CURLOPT_POST, false); 
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET'); 

// Cabeçalhos limpos exigidos estritamente pelo Supabase
